...
export default {
    data: new SlashCommandBuilder()
        .setName('level').setDescription('إدارة نظام المستويات')
        .setDefaultMemberPermissions(PermissionFlagsBits.ManageGuild)
        .setDMPermission(false)
        .addSubcommand((subcommand) =>
            subcommand
                .setName('setup').setDescription('إعداد نظام المستويات — هذا يفعّله تلقائيًا')
        ...
        .addSubcommand((subcommand) =>
            subcommand
                .setName('dashboard').setDescription('فتح لوحة إعدادات نظام المستويات التفاعلية'),
        ),
    category: 'Leveling',
