...
export default {
  data: new SlashCommandBuilder()
    .setName('count').setDescription('إدارة لعبة العد في السيرفر')
    .setDefaultMemberPermissions(PermissionFlagsBits.ManageGuild)
    .setDMPermission(false)
    .addSubcommand((subcommand) =>
      subcommand
        .setName('setup').setDescription('بدء لعبة عد في روم نصي')
    ...
    .addSubcommand((subcommand) =>
      subcommand
        .setName('reset').setDescription('إعادة تعيين تسلسل العد الحالي')
    ...
    .addSubcommand((subcommand) =>
      subcommand.setName('leaderboard').setDescription('عرض قائمة المتصدرين للعبة العد'),
    ),
  category: 'Fun',
