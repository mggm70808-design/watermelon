...
export default {
    data: new SlashCommandBuilder()
        .setName('autorole').setDescription('إدارة الرتب اللي تُعطى تلقائيًا للأعضاء الجدد')
        .setDefaultMemberPermissions(PermissionFlagsBits.ManageGuild)
        .addSubcommand(subcommand =>
            subcommand
                .setName('add').setDescription('إضافة رتبة تُعطى تلقائيًا للأعضاء الجدد')
        ...
        .addSubcommand(subcommand =>
            subcommand
                .setName('remove').setDescription('إزالة رتبة من الإعطاء التلقائي')
                .addRoleOption(option =>
                    option.setName('role')
        ...
        .addSubcommand(subcommand =>
            subcommand
                .setName('list').setDescription('عرض كل الرتب التلقائية')),
