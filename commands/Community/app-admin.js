...
export default {
    ...
    .setName("app-admin").setDescription("إدارة طلبات التوظيف")
    .setDefaultMemberPermissions(PermissionFlagsBits.ManageGuild)
    .addSubcommand((subcommand) =>
        subcommand
            .setName("setup").setDescription("إعداد طلب توظيف جديد")
    )
    .addSubcommand((subcommand) =>
        subcommand
            .setName("review").setDescription("قبول أو رفض طلب")
    ...
    .addSubcommand((subcommand) =>
        subcommand
            .setName("list").setDescription("عرض كل الطلبات")
            .addStringOption((option) =>
                option
                    .setName("status")
    ...
    .addSubcommand((subcommand) =>
        subcommand
            .setName("dashboard").setDescription("فتح لوحة إعدادات الطلبات")
            .addStringOption((option) =>
                option
                    .setName("application")
