...
export default {
    ...
    data: new SlashCommandBuilder()
        .setName("apply").setDescription("إدارة طلبات الرتب")
        .addSubcommand((subcommand) =>
            subcommand
                .setName("submit").setDescription("تقديم طلب للحصول على رتبة")
        ...
        .addSubcommand((subcommand) =>
            subcommand
                .setName("status").setDescription("التحقق من حالة طلبك")
                .addStringOption((option) =>
                    option
                        .setName("id")
        ...
        .addSubcommand((subcommand) =>
            subcommand
                .setName("list").setDescription("عرض الطلبات المتاحة للتقديم"),
        ),
