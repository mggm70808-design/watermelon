...
export default {
    data: new SlashCommandBuilder()
        .setName("jointocreate").setDescription("إدارة نظام رومات الصوت التلقائية (انضم لتنشئ).")
        .setDefaultMemberPermissions(PermissionFlagsBits.ManageGuild)
        .setDMPermission(false)
        .addSubcommand((subcommand) =>
            subcommand
                .setName("setup").setDescription("إعداد روم صوتي جديد تلقائي (انضم لتنشئ).")
        ...
        .addSubcommand((subcommand) =>
            subcommand
                .setName("dashboard").setDescription("تعديل إعدادات نظام الروم الصوتي التلقائي الحالي.")
                .addChannelOption((option) =>
                    option
