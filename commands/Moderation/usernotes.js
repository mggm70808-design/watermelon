...
export default {
    data: new SlashCommandBuilder()
        .setName("usernotes").setDescription("إدارة ملاحظات الأعضاء لأغراض الإشراف")
        .addSubcommand(subcommand =>
            subcommand
                .setName("add").setDescription("إضافة ملاحظة لعضو")
        ...
        .addSubcommand(subcommand =>
            subcommand
                .setName("view").setDescription("عرض ملاحظات عضو")
                .addUserOption(option =>
                    option
                        .setName("target")
        ...
        .addSubcommand(subcommand =>
            subcommand
                .setName("remove").setDescription("حذف ملاحظة محددة من عضو")
                .addUserOption(option =>
                    option
                        .setName("target")
        ...
        .addSubcommand(subcommand =>
            subcommand
                .setName("clear").setDescription("حذف كل ملاحظات عضو")
                .addUserOption(option =>
                    option
                        .setName("target")
