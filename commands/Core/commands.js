...
export default {
  data: new SlashCommandBuilder()
    .setName('commands').setDescription('تفعيل أو تعطيل أوامر وفئات البوت لهذا السيرفر')
    .setDefaultMemberPermissions(PermissionFlagsBits.ManageGuild)
    .setDMPermission(false)
    .addSubcommand((subcommand) =>
      subcommand
        .setName('dashboard').setDescription('فتح لوحة التحكم التفاعلية بصلاحيات الأوامر'),
    )
    .addSubcommand((subcommand) =>
      subcommand
        .setName('disable').setDescription('تعطيل أمر أو فئة كاملة')
    ...
    .addSubcommand((subcommand) =>
      subcommand
        .setName('enable').setDescription('تفعيل أمر أو فئة كاملة')
        .addStringOption((option) =>
          option
            .setName('scope')
