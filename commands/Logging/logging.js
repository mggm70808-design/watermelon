...
export default {
    data: new SlashCommandBuilder()
        .setName('logging').setDescription('إدارة نظام السجلات — الرومات والفلاتر وفئات الأحداث.')
        .setDefaultMemberPermissions(PermissionFlagsBits.ManageGuild)
        .setDMPermission(false)
        .addSubcommand((subcommand) =>
            subcommand
                .setName('dashboard').setDescription('فتح لوحة السجلات — تعيين الرومات والفلاتر وتفعيل الفئات.'),
        )
        .addSubcommand((subcommand) =>
            subcommand
                .setName('channel').setDescription('تعيين سريع لروم السجلات بدون فتح اللوحة.')
