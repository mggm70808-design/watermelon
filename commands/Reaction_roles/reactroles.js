...
export default {
    data: new SlashCommandBuilder()
        .setName('reactroles').setDescription('إدارة رتب التفاعل')
        .setDefaultMemberPermissions(PermissionFlagsBits.Administrator)
        .addSubcommand(subcommand =>
            subcommand
                .setName('setup').setDescription('إعداد لوحة رتب تفاعل جديدة')
        ...
        .addSubcommand(subcommand =>
            subcommand
                .setName('dashboard').setDescription('إدارة وتعديل لوحات رتب التفاعل')
                .addStringOption(option =>
                    option
                        .setName('panel')
