...
export default {
    data: new SlashCommandBuilder()
        .setName("autoverify").setDescription("تعديل إعدادات التوثيق التلقائي")
        .setDefaultMemberPermissions(PermissionFlagsBits.ManageGuild)
        .addSubcommand(subcommand =>
            subcommand
                .setName("setup").setDescription("إعداد التوثيق التلقائي")
        ...
        .addSubcommand(subcommand =>
            subcommand
                .setName("dashboard").setDescription("فتح لوحة تخصيص التوثيق التلقائي")
        ),
