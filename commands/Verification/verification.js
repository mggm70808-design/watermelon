...
export default {
    data: new SlashCommandBuilder()
        .setName("verification").setDescription("إدارة نظام توثيق السيرفر")
        .addSubcommand(subcommand =>
            subcommand
                .setName("setup").setDescription("إعداد نظام التوثيق")
        ...
        .addSubcommand(subcommand =>
            subcommand
                .setName("remove").setDescription("إزالة التوثيق عن عضو")
        ...
        .addSubcommand(subcommand =>
            subcommand
                .setName("dashboard").setDescription("فتح لوحة إعدادات نظام التوثيق")
        ),
